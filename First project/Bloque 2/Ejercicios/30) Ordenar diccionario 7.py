...
for i in range(len(list)):
    ...
    for j in range(len(list)-i-1):
        if int(list[j][len(list)-2:len(list)+1]) > int(list[j+1][len(list)-2:len(list)+1]):
            flgc = True
            cn = list[j]
            list[j] = list[j+1]
            list[j+1] = cn
...
for i in range(len(characters)):
    if len(characters[list[i]]["items"]) == 0:
        print(f"{list[i]}".ljust(16)+f"{characters[list[i]]["name"]}".ljust(10)+"".ljust(10)+f"{characters[list[i]]["strength"]}".ljust(10)+f"{characters[list[i]]["defense"]}".ljust(10)+f"{characters[list[i]]["agility"]}".ljust(10)+f"{characters[list[i]]["stamina"]}".rjust(10))
    else:
        print(f"{list[i]}".ljust(16)+f"{characters[list[i]]["name"]}".ljust(10)+f"{characters[list[i]]["items"][0]}".ljust(10)+f"{characters[list[i]]["strength"]}".ljust(10)+f"{characters[list[i]]["defense"]}".ljust(10)+f"{characters[list[i]]["agility"]}".ljust(10)+f"{characters[list[i]]["stamina"]}".rjust(10))
    if len(characters[list[i]]["items"]) > 1:
        for j in range(len(characters[list[i]]["items"])-1):
            print("".ljust(16)+"".ljust(10)+f"{characters[list[i]]["items"][j+1]}".ljust(10))
    print("-"*76)