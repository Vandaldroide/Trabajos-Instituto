...
# profesor en clase.
#Cojer el centro de la imagen
comprimida_r = []
comprimida_g = []
comprimida_b = []
mitad_alto = alto//2
cuarto_ancho = ancho//4
cuarto_alto = alto//4
for i in range(mitad_alto):
        comprimida_r.append(matriz_r[cuarto_alto+i][cuarto_ancho:ancho-cuarto_ancho])
        comprimida_g.append(matriz_g[cuarto_alto+i][cuarto_ancho:ancho-cuarto_ancho])
        comprimida_b.append(matriz_b[cuarto_alto+i][cuarto_ancho:ancho-cuarto_ancho])
