...
# profesor en clase.
#Cojer el cuarto inferior derecho
comprimida_r = []
comprimida_g = []
comprimida_b = []
mitad = ancho//2
...
for i in range(mitad_alto):
        comprimida_r.append(matriz_r[mitad_alto+i][mitad:])
        comprimida_g.append(matriz_g[mitad_alto+i][mitad:])
        comprimida_b.append(matriz_b[mitad_alto+i][mitad:])
