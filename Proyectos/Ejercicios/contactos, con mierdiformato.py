...
filas = "" #datos guardados para procesar en la tabla
opc = 0 #selector del segundo menu
comas = 0 #contabliza las comas que llevamos en esta linea
idat = 0
while not salir:
    if menu == 0: #Menu Principal
        ...
        if not opc.isdigit():
            ...
            if opc == 1:
                ...
                if not tlfm:
                    datos = f"{nombre},{telefono},0,{mail};"
                    ...
                    datos = f"{nombre},0,{telefono},{mail};"
                    print( #te dice los datos que vas a guardar
                        "estos son los datos: \n"+
                        "*" * 55 + "\n" +
        ...
        print(
            "Contactos".center(70,"*")+"\n"+
            "Nombre".ljust(15)+"Telefono Movil".ljust(15)+"Telefono Fijo".ljust(15)+"Mail".rjust(25)+"\n"+
            "*"*70
        )
        for i in range(0,len(filas)):
            if filas[i] == ",":
                if comas == 0:
                    comas += 1
                    print(f"{filas[idat:i]}".ljust(15),end="")
                    idat = i+1
                elif comas == 1:
                    comas += 1
                    if filas[i+1] == "0":
